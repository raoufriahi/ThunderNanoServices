...
namespace Plugin {
    ...
    private:
        ...
        public:
            ...
            explicit Notification(HelloRiahi* parent)
                : _parent(*parent)
            {
    ...
    public:
        HelloRiahi(const HelloRiahi&) = delete;
        HelloRiahi& operator=(const HelloRiahi&) = delete;
...
POP_WARNING()
    ...
    public:
        BEGIN_INTERFACE_MAP(HelloRiahi)
        INTERFACE_ENTRY(PluginHost::IPlugin)
        INTERFACE_ENTRY(PluginHost::IWeb)
        INTERFACE_ENTRY(Exchange::IHelloRiahi)
    ...
    public:
        ...
        //  IHelloRiahi methods
        // -------------------------------------------------------------------------------------------------------
        Core::hresult Register(Exchange::IHelloRiahi::INotification* const sink) override;
        Core::hresult Unregister(const Exchange::IHelloRiahi::INotification* const sink) override;
        Core::hresult GetState(Exchange::IHelloRiahi::PCState& state) const override;
        Core::hresult SetState(const Exchange::IHelloRiahi::PCState& state, const uint32_t waitTime) override;
        void HelloRiahiMessage() override;
    ...
    private:
        ...
        std::list<Exchange::IHelloRiahi::INotification*> _notificationClients;
    };
} //namespace Plugin
} //namespace Thunder
