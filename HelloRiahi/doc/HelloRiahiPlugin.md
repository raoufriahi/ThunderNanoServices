...
HelloRiahi plugin for Thunder framework.
...
This document describes purpose and functionality of the HelloRiahi plugin. It includes detailed specification about its configuration, methods and properties as well as sent notifications.
